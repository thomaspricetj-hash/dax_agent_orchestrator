...
Integration test tests/full_smoke.rs added

Re-export guidance: keep with #[allow(unused_imports)] or remove for internal crates

Release notes (short):
Updated README with production-ready guidance, example fixes, and CI/test instructions.
